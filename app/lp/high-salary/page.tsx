...
export default function HighSalaryLP() {
  return (
    <>
      ...
      <main className="l-main">
          ...
          <div className="p-fv__text-wrapper p-fv__text-wrapper--5chars">
            <p className="p-fv__lead">
              ...
              <span className="--margin">
                <span className="p-fv__carrier-up">年</span>
            ...
            <div className="p-fv__text">
              月給50万円以上の求人多数！<br />あなたの技術に見合った<br className="u-sp" />高収入求人を厳選紹介！<br />キャリアと収入を両立！
            </div>
          </div>
          <div className="p-fv__box">
            <p className="p-fv__message">
              「寿司職人専門」のキャリアアドバイザーが、<br />高収入のキャリアを無料サポート！
            </p>
        ...
        <section className="p-cta">
          <p className="p-cta__message">「寿司職人専門」のキャリアアドバイザーが、<br />高収入のキャリアを無料サポート！</p>
        ...
        <section className="p-footer-cta">
          <div className="l-inner">
            <div className="p-footer-cta__contents">
              <p className="p-footer-cta__text--sub">「寿司職人専門」のキャリアアドバイザーが、<br className="u-sp" />高収入のキャリアを無料サポート！</p>
